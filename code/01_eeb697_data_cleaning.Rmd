...
Cleaning the data included exploring the data, removing unnecessary columns, defining the timestamps in the proper time zone, and joining tabular data together to make a data base for analysis.
