...
# define packages
packages <- c("tidyverse", "dplyr", "tidyr", "gtools", "ggplot2", "lubridate", "reshape2", "plyr", "rgdal", "sp", "sf", "maptools", "raster", "amt", "FedData", "tiff", "terra", "rasterVis", "glmmTMB", "circular", "ctmm")
...
sumtrks[[1]] # about 15 min is the median, the mean is much higher but that is because of the maximum values. I am going to resample at 15 min, with a 5 minute tolerance.
